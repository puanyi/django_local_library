...
class AuthorCreateViewTest(TestCase):
    def setUp(self):
        ...
        test_author = Author.objects.create(first_name='Christian Name', last_name='Surname')
    ...
    def test_date_of_death_initially_value_are_certain(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author_create'))
        self.assertEqual(response.status_code, 200)
        ...
        the_date_of_death = '05/01/2018'
        self.assertEqual(response.context['form'].initial['date_of_death'], the_date_of_death)
